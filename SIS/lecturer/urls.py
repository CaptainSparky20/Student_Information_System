...
urlpatterns = [
    ...
    path('students/<int:student_id>/disciplinary-action/', views.take_disciplinary_action, name='take_disciplinary_action'),
    ...
    path('students/<int:student_id>/take-disciplinary-action/', views.take_disciplinary_action, name='take_disciplinary_action'),
    ...
    path('classgroup/<int:classgroup_id>/export/students/', views.export_class_students, name='export_class_students'),
]
