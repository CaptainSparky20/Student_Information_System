...
class LecturerCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "identity_card_number": forms.TextInput(
                attrs={
                    "class": "w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-600",
...
class AddStudentForm(forms.Form):
    ...
    full_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": base_input_class, "placeholder": "Enter full name"}
        ),
    )
    ...
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={"class": base_input_class, "placeholder": "student@example.com"}
        ),
    )
    identity_card_number = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": base_input_class, "placeholder": "e.g. 001231-14-1234"}
        ),
    )
    password = forms.CharField(
        widget=forms.PasswordInput(
    ...
    confirm_password = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"class": base_input_class, "placeholder": "Re-enter password"}
        ),
        label="Confirm Password",
        required=False,
    )
    ...
    phone_number = forms.CharField(
        ...
        label="Phone Number",
        widget=forms.TextInput(
            attrs={"class": base_input_class, "placeholder": "Optional"}
        ),
    )
    address = forms.CharField(
        widget=forms.Textarea(
            attrs={"class": base_input_class, "placeholder": "Optional", "rows": 3}
        ),
        required=False,
        label="Address",
    )
    ...
    def clean_identity_card_number(self):
        ...
        if CustomUser.objects.filter(identity_card_number=value).exists():
            raise forms.ValidationError(
                "A user with this identity card number already exists."
            )
        return value
