...
urlpatterns = [
    ...
    path(
        "students/classgroups_by_department/",
        views.get_classgroups_by_department,
        name="get_classgroups_by_department",
    ),
    ...
    path(
        "classgroup/<int:pk>/assign-lecturers/",
        views.assign_lecturer_classgroup,
        name="assign_lecturer_classgroup",
    ),
    ...
    path(
        "fees/student/<int:student_id>/new/",
        views.fee_plan_create_for_student,
        name="fee_plan_create_for_student",
    ),
    path("fees/plan/<int:plan_id>/", views.fee_plan_detail, name="fee_plan_detail"),
    path(
        "fees/plan/<int:plan_id>/generate/",
        views.fee_plan_generate_installments,
        name="fee_plan_generate_installments",
    ),
    path(
        "fees/installment/<int:pk>/toggle/",
        views.installment_toggle_paid,
        name="installment_toggle_paid",
    ),
]
